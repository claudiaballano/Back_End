...
const url = `mongodb+srv://root:root@cluster0.kpgip.mongodb.net/crunchbase?retryWrites=true&w=majority`
            ...
            switch (option) {
                ...
                case "4":
                    db.collection('companies')
                        ...
                        .project({ name: 1, _id: 0 }) // Check it adding: founded_year:1,founded_month:1
                ...
                case "5":
                    db.collection('companies')
                        ...
                        .sort({ created_at: -1 })
                        .project({ name: 1, _id: 0, created_at: 1 }) // Check it adding: founded_year:1,founded_month:1, created_at: 1
                        .toArray((error, result) => {
                            if (error) {
                                console.log(error);
                                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
